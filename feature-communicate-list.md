...
200536
Web: As an Authenticated Practitioner, I should be able to sign out of the application when I have completed my shift, so that other Practitioners are informed that I am no longer present in the system
===========================================================================================================================================================================================================
- `enableSignoutPrompt` flag has been introduced in order to display logout prompt. By default matrix showed encryption based text message which informs users "logging out will display encryption key to be backed up before signing out as accessing end to end to end encrypted messages". Since , encryption is turned off from user homeserver and this is checked in front end by doing lookup within wellknownConfig lookup in `WellKnownE2EUtil` file.
