...
5) The secondary vertical and horizontal logos use alt key description which comes from secondary_logo_description which is configurable flag to control image description and we can change this description on config file as we want and this description would aid WCAG compliance on image description.
