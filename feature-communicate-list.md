...
5) The secondary logo uses secondary_logo_description which is configurable flag to control image description and we can change this description on config file as we want and this description would aid WCAG compliance on image description. This config value has been used by vertical and horizontal act govt. images.
